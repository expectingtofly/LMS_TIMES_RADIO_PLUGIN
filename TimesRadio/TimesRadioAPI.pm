...
sub getSchedule {
    ...
    my $request =
      HTTP::Request->new( POST => 'https://newskit.newsapis.co.uk/graphql' );
    $request->header( 'Content-Type' => 'application/json' );
    $request->header( 'x-api-key'    => 'etWuAuwzqUbD2tBXMh5ZP5Qxfs0LZPDK' );

    my $body = '{'
      . '"operationName":"GetRadioSchedule",'
      . '"variables":{"from":"'
      . $d
      . '","to":"'
      . $d . '"},'
      . '"query":"query GetRadioSchedule($from: Date, $to: Date) {\n  radioSchedule(stationId: timesradio, from: $from, to: $to) {\n    id\n    date\n    shows {\n      id\n      title\n      description\n      startTime\n      endTime\n      recording {\n        url\n        __typename\n      }\n      images {\n        url\n        width\n        metadata\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n"}';
